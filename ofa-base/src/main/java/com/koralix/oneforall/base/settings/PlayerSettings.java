...
public class PlayerSettings {
    ...
    public static final PlayerConfigValue<SettingMode, ByteBuf> CAREFUL_BREAK = REGISTRAR
            .player(VersionedIdentifier.of("0.1.0", OneForAll.id("careful_break")), SettingMode.ALWAYS, SettingMode.CODEC, SettingMode.PACKET_CODEC, a -> false, a -> false)
            .test(Objects::nonNull)
            .build();

    public static final PlayerConfigValue<SettingMode, ByteBuf> XP_BAR_MENDING = REGISTRAR
            .player(VersionedIdentifier.of("0.1.0", OneForAll.id("xp_bar_mending")), SettingMode.ALWAYS, SettingMode.CODEC, SettingMode.PACKET_CODEC, a -> false, a -> false)
            .test(Objects::nonNull)
            .build();
